...
if BOT_TOKEN == "default_token_placeholder" or API_ID == 1234567 or API_HASH == "default_hash_placeholder":
    print("❌ ERROR: Please set Environment Variables in Render!")
...
async def ping_command(client, message):
    ...
    ping_time = round((end_time - start_time_ping) * 1000, 2)
...
async def main():
    logger.info("🚀 Starting File Store Bot on Render...")
...
if __name__ == "__main__":
    print("🟢 Script started executing on Render...")
    try:
        asyncio.run(main())
